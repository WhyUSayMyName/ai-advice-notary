...
export function buildChainReport(records: ArtifactRecord[]): VersionChainReport {
...
export function buildChainReports(artifacts: ArtifactRecord[]): VersionChainReport[] {
